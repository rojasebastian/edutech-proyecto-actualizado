...
public class CourseCategoryService {
    ...
    public CourseCategoryDTO findById(Integer id) {
        return CourseCategoryDTO.fromEntity(repo.findById(id).orElseThrow(()-> new ResourceNotFoundException("No encontrada")));
    }
    ...
    public CourseCategoryDTO update(Integer id, CourseCategoryDTO dto) {
        repo.findById(id).orElseThrow(()-> new ResourceNotFoundException("No encontrada"));
        CourseCategory entity = dto.toEntity();
        entity.setId(id);
        return CourseCategoryDTO.fromEntity(repo.save(entity));
    }
    public void delete(Integer id) {
        repo.delete(repo.findById(id).orElseThrow(() -> new ResourceNotFoundException("No encontrada")));
    }
}
